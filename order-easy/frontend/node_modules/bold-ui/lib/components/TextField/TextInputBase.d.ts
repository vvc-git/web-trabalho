 ...
 */
export declare function TextInputBase(props: TextInputBaseProps): JSX.Element;
export declare namespace TextInputBase {
    var defaultProps: Partial<TextInputBaseProps>;
}
export declare const createStyleParts: (theme: Theme) => {
...
export declare const createStyles: (theme: Theme) => {
    input: {
        '::placeholder': React.CSSProperties;
        ':disabled': React.CSSProperties;
        ':not(:disabled):hover': React.CSSProperties;
        ':not(:disabled):focus': React.CSSProperties;
        ':not(:disabled):active': React.CSSProperties;
        alignContent?: string;
        alignItems?: string;
        alignSelf?: string;

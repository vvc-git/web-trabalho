 ...
 */
export declare function getKeyDirection(key: string): "left" | "right" | "down" | "up";
/**
 ...
 */
export declare function getQuantityValue(filterOne: Set<string>, filterTwo: string[]): ActualQuantity;

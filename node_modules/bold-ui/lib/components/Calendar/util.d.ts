 ...
 */
export declare const getFirstDayOfMonth: (target: Date) => Date;
/**
 * Calculate the last day of a month.
 * @param target  Target month.
 * @returns A new date which is the last day of the target month.
 */
export declare const getLastDayOfMonth: (target: Date) => Date;
/**
 ...
 */
export declare const createWeekArray: (target: Date) => Date[];
/**
 ...
 */
export declare const createMonthMatrix: (target: Date) => Date[][];
/**
 ...
 */
export declare const isBelongingAWeek: (day: Date, week: Week) => boolean;
/**
